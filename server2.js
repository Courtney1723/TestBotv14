...
// server.all('/', (req, res)=>{
//     res.send(`
// 		<div style="background-color:#00A6A4; height:100%; width:100%; text-align:center">
...
// 		 	</p>
// 			<p>
// 		 			<img src="${process.env.logo_link}" width="280px" height="280px" /img>
// 			</p>
// 	 		<p style="font-size:6vmax;">
